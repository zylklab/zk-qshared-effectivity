function main()
{
   ...
   if (result.status == 200)
   {
      ...
      model.downloadUrl = url.context+"/proxy/alfresco-noauth/api/internal/shared/node/"+shareId+"/content/"+nodeMetadata.name+"?c=force&noCache="+new Date().getTime()+"&a=true";
   }
